    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-emerald-800 mb-4">Oifig Fhíorúil / Virtual Office</h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {quickLinks.map((link, index) => (
            <Link key={index} href={link.link}>
              <Card className="border-emerald-200 hover:shadow-lg transition-all hover:scale-105 cursor-pointer">
                <CardHeader className="text-center">
                  <div className="text-4xl mb-2">{link.icon}</div>
                  <CardTitle className="text-emerald-800 text-lg">{link.title}</CardTitle>
                  <p className="text-emerald-600 font-medium text-sm">{link.titleEn}</p>
                </CardHeader>
        ...
        {/* Documents Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-emerald-800 text-center mb-8">Cáipéisí / Documents</h2>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-semibold text-emerald-800 mb-1">{doc.title}</h3>
                        <p className="text-emerald-600 text-sm mb-2">{doc.titleEn}</p>
