...
import { ArrowLeft, Calendar, Lightbulb, Handshake } from "lucide-react"
import Link from "next/link"
import { getCouncilPageBySlug } from "@/lib/school-council-data"
import { notFound } from "next/navigation"

export default function WorkPage() {
  const pageData = getCouncilPageBySlug("work")
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-8">
          {pageData.sections.map((section, index) => {
            const icons = [Calendar, Lightbulb, Handshake];
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <Button asChild variant="outline" className="h-auto p-4">
                  <Link href="/school-council/long-term-goals" className="text-center">
                    <div className="space-y-1">
                      <div className="font-medium">Spriocanna Fadtéarmacha</div>
